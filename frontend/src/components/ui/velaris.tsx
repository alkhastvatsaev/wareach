...
/** WAREACH teal / graphite palette (not purple). */
const DEFAULT_COLORS = ["#5eead4", "#0d7377", "#134e4a", "#0c1419"];
...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    const paint = (t: number) => {
      ...
      gl.uniform1f(locs.time, t * 0.001 * (reduce ? 0 : speed));
  ...
  return (
    <div
      ref={containerRef}
      style={{ height, minHeight: height === "100%" ? "100vh" : undefined }}
